...
def get_conceptnet():
	...
	conceptnet_filename_zipped = os.path.join('data', conceptnet_url.split('/')[-1])
	...
	conceptnet_filename_filtered = os.path.join('data', 'conceptnet-en-5.7.0.txt')
	...
	print('Done!\n')
	return conceptnet_filename_filtered
...
def get_numberbatch():
	...
	print('Done!\n')
	return numberbatch_filename

########
# MAIN #
########
def main():
	# Download conceptnet and numberbatch
	conceptnet_filename_filtered = get_conceptnet()
